      ...
      <div class="page-header">
        ...
        <div class="js-nav-scroller hs-nav-scroller-horizontal">
          ...
          <ul class="nav nav-tabs page-header-tabs" id="projectsTab" role="tablist">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="./project-settings.php">Settings</a>
            </li>
          </ul>
        </div>
        <!-- End Nav -->
              ...
              <div class="mb-4">
                ...
                <div class="d-flex align-items-center">
                  ...
                  <label class="avatar avatar-xl avatar-circle avatar-uploader me-5" for="avatarUploader">
                    <img id="avatarProjectSettingsImg" class="avatar-img" src="./assets/svg/brands/guideline-icon.svg" alt="Image Description">
