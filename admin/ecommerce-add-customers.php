            ...
            <div class="card-body">
              <div class="row">
                <div class="col-sm-6">
                  <!-- Form -->
                  <div class="mb-4">
                    <label for="firstNameAddressLabel" class="form-label">First name</label>
                ...
                <div class="col-sm-6">
                  <!-- Form -->
                  <div class="mb-4">
                    <label for="lastNameAddressLabel" class="form-label">Last name</label>
              ...
              <!-- Form -->
              <div class="mb-4">
                <label for="addressLocationLabel" class="form-label">Location</label>
                ...
                <div class="tom-select-custom mb-3">
                  <select class="js-select form-select" id="addressLocationLabel" autocomplete="off" data-hs-tom-select-options='{
                    ...
                    <option value="GB" data-option-template='<span class="d-flex align-items-center"><img class="avatar avatar-xss avatar-circle me-2" src="./assets/vendor/flag-icon-css/flags/1x1/gb.svg" alt="United Kingdom Flag" /><span class="text-truncate">United Kingdom</span></span>'>United Kingdom</option>
              ...
              <!-- Form -->
              <div class="mb-4">
                <label for="AddressLine1Label" class="form-label">Address line 1</label>
              ...
              <!-- Form -->
              <div class="mb-4">
                <label for="AddressLine2Label" class="form-label">Address line 2 <span class="form-label-secondary">(Optional)</span></label>
              ...
              <!-- Form -->
              <div class="mb-4">
                <label for="addresszipCodeLabel" class="form-label">Zip code <i class="bi-question-circle text-body ms-1" data-bs-toggle="tooltip" data-bs-placement="top" title="You can find your code in a postal address."></i></label>

                <input type="text" class="js-input-mask form-control" name="addresszipCode" id="addresszipCodeLabel" placeholder="Your zip code" aria-label="Your zip code" data-hs-mask-options='{
                         "mask": "AA0 0AA"
                       }'>
              </div>
              <!-- End Form -->
              ...
              <div class="form-check mb-4">
                ...
                <label class="form-check-label" for="billingAddressCheckbox">Same as shipping address</label>
              </div>
              <!-- End Form Check -->
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-sm-6">
                  <!-- Form -->
                  <div class="mb-4">
                    <label for="firstNameBillingAddressLabel" class="form-label">First name</label>
                ...
                <div class="col-sm-6">
                  <!-- Form -->
                  <div class="mb-4">
                    <label for="lastNameBillingAddressLabel" class="form-label">Last name</label>
              ...
              <!-- Form -->
              <div class="mb-4">
                <label for="billingLocationLabel" class="form-label">Location</label>

                <!-- Select -->
                <div class="tom-select-custom mb-4">
                  <select class="js-select form-select" id="billingLocationLabel" autocomplete="off" data-hs-tom-select-options='{
                            "placeholder": "Select country"
                          }'>
                    <option value="AF" data-option-template='<span class="d-flex align-items-center"><img class="avatar avatar-xss avatar-circle me-2" src="./assets/vendor/flag-icon-css/flags/1x1/af.svg" alt="Afghanistan Flag" /><span class="text-truncate">Afghanistan</span></span>'>Afghanistan</option>
                    <option value="AX" data-option-template='<span class="d-flex align-items-center"><img class="avatar avatar-xss avatar-circle me-2" src="./assets/vendor/flag-icon-css/flags/1x1/ax.svg" alt="Aland Islands Flag" /><span class="text-truncate">Aland Islands</span></span>'>Aland Islands</option>
              ...
              <!-- Form -->
              <div class="mb-4">
                <label for="billingAddressLine1Label" class="form-label">Address line 1</label>
              ...
              <!-- Form -->
              <div class="mb-4">
                <label for="billingAddressLine2Label" class="form-label">Address line 2 <span class="form-label-secondary">(Optional)</span></label>
              ...
              <!-- Form -->
              <div class="mb-4">
                <label for="billingZipCodeLabel" class="form-label">Zip code <i class="bi-question-circle text-body ms-1" data-bs-toggle="tooltip" data-bs-placement="top" title="You can find your code in a postal address."></i></label>

                <input type="text" class="js-input-mask form-control" name="billingZipCode" id="billingZipCodeLabel" placeholder="Your zip code" aria-label="Your zip code" data-hs-mask-options='{
                         "mask": "AA0 0AA"
                       }'>
              </div>
              <!-- End Form -->
