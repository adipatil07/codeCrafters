...
<head>
    <!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-Z4WV287JS8"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-Z4WV287JS8');
</script>
    <meta charset="utf-8">
<title>Payment - Tech King Solutions India</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="" name="keywords">
    <meta content="" name="description">

    <!-- Favicon -->
    <link href="img/head.ico" rel="icon">
...
<body>
 ...
 <img src="assets/svg/logos/paymentsucess.gif">
        ...
        <p>
        You can now start promoting your club and inviting members. Don't forget to check back for updates and manage your club details as needed.</p>
