...
<head>
  ...
  <!-- Title -->
  <title>Activity | Front - Admin &amp; Dashboard Template</title>
      ...
      <div class="page-header">
        ...
        <div class="js-nav-scroller hs-nav-scroller-horizontal">
          ...
          <ul class="nav nav-tabs page-header-tabs" id="projectsTab" role="tablist">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="./project-activity.php">Activity</a>
            </li>
            <li class="nav-item">
        ...
        <div class="col-lg-9">
            ...
            <li class="step-item">
              <div class="step-content-wrapper">
                ...
                <div class="step-content">
                  ...
                  <p class="fs-5 mb-1">Uploaded weekly reports to the task <a class="text-uppercase" href="#"><i class="bi-journal-bookmark-fill"></i> Fd-7</a></p>
            ...
            <li class="step-item">
              <div class="step-content-wrapper">
                ...
                <div class="step-content">
                  ...
                  <p class="fs-5 mb-1">Marked project status as <span class="badge bg-soft-primary text-primary rounded-pill"><span class="legend-indicator bg-primary"></span>"In progress"</span></p>
                </div>
              </div>
            </li>
            <!-- End Step Item -->
            ...
            <li class="step-item">
              <div class="step-content-wrapper">
                ...
                <div class="step-content">
                  ...
                  <p class="fs-5">Marked project status as <span class="badge bg-soft-primary text-primary rounded-pill"><span class="legend-indicator bg-primary"></span>"In progress"</span></p>
                </div>
              </div>
            </li>
            <!-- End Step Item -->
          ...
          <div class="d-grid">
            <a class="btn btn-white" href="javascript:;">
              <i class="bi-arrow-clockwise me-1"></i> Load more activities
            </a>
          </div>
          <!-- End Footer -->
        </div>
