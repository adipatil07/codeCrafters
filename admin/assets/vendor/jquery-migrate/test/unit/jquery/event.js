...
TestManager.runIframeTest( "document ready", "event-ready.php",
...
TestManager.runIframeTest( "jQuery.event.props.concat", "event-props-concat.php",
...
TestManager.runIframeTest( "jQuery.event.props", "event-props.php",
...
// Do this as iframe because there is no way to undo prop addition
TestManager.runIframeTest( "jQuery.event.fixHooks", "event-fixHooks.php",
	function( assert, jQuery, window, document, log, test1, test2 ) {
		assert.expect( 2 );
...
TestManager.runIframeTest( "Load within a ready handler", "event-lateload.php",
