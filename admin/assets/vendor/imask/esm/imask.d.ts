...
declare function IMask<Opts extends IMask.AnyMaskedOptions>(
  el: IMask.MaskElement | IMask.phpMaskingElement,
  opts: Opts
...
export import HTMLMaskElement = IMask.phpMaskElement;
export import HTMLContenteditableMaskElement = IMask.phpContenteditableMaskElement;
