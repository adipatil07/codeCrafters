      ...
      <div class="page-header">
        <div class="row align-items-end">
          <div class="col-sm mb-2 mb-sm-0">
            ...
            <h1 class="page-header-title">Club Name Here</h1>
          </div>
          <!-- End Col -->

          <div class="col-sm-auto">
            <a class="btn btn-primary" href=".\pendingreq.php">
              <i class="bi-person-plus-fill me-1"></i> Pending Request
            </a>
          </div>
          <!-- End Col -->
        </div>
          ...
          <table id="datatable" class="table table-lg table-borderless table-thead-bordered table-nowrap table-align-middle card-table" data-hs-datatables-options='{
            ...
            <tbody>
              <tr>
                ...
                <button type="button" class="btn btn-ghost-danger">Remove</button>
          ...
          <div class="tab-content" id="editUserModalTabContent">
            <div class="tab-pane fade show active" id="profile" role="tabpanel" aria-labelledby="profile-tab">
              <form>
                ...
                <!-- Form -->
                <div class="row mb-4">
                  <label for="editOrganizationModalLabel" class="col-sm-3 col-form-label form-label" Required>Venue</label>
