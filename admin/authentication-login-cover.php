            ...
            <form class="js-validate needs-validation" novalidate>
              <div class="text-center">
                <div class="mb-5">
                  ...
                  <p>Don't have an account yet? <a class="link" href="./authentication-signup-cover.php">Sign up here</a></p>
                </div>
              ...
              <div class="mb-4">
                <label class="form-label w-100" for="signupSrPassword" tabindex="0">
                  <span class="d-flex justify-content-between align-items-center">
                    <span>Password</span>
                    <a class="form-label-link mb-0" href="./authentication-reset-password-cover.php">Forgot Password?</a>
                  </span>
                </label>
