      ...
      <div class="row justify-content-lg-center">
        <div class="col-lg-10">
          ...
          <div class="text-center mb-5">
            ...
            <h1 class="page-header-title">Mark Williams <i class="bi-patch-check-fill fs-2 text-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="Top endorsed"></i></h1>
            ...
            <ul class="nav nav-tabs align-items-center">
              ...
              <li class="nav-item ms-auto">
                <div class="d-flex gap-2">
                  <a class="btn btn-white btn-sm" href="./account-settings.php">
            ...
            <div class="col-lg-4">
              ...
              <div class="card card-lg mb-3 mb-lg-5">
                ...
                <div class="card-body text-center">
                  <div class="mb-4">
                    <img class="avatar avatar-xl avatar-4x3" src="./assets/svg/illustrations/oc-unlock.svg" alt="Image Description" data-hs-theme-appearance="default">
                    <img class="avatar avatar-xl avatar-4x3" src="./assets/svg/illustrations-light/oc-unlock.svg" alt="Image Description" data-hs-theme-appearance="dark">
                  </div>
            ...
            <div class="col-lg-8">
              ...
              <div class="card card-centered mb-3 mb-lg-5">
                ...
                <div class="card-body card-body-height card-body-centered">
                  ...
                  <img class="avatar avatar-xxl mb-3" src="./assets/svg/illustrations-light/oc-error.svg" alt="Image Description" data-hs-theme-appearance="dark">
                  <p class="card-text">No data to show</p>
                  <a class="btn btn-white btn-sm" href="./projects.php">Start your Projects</a>
                </div>
                <!-- End Body -->
              </div>
              <!-- End Card -->
