      ...
      <div class="page-header">
        <div class="row align-items-end">
          <div class="col-sm mb-2 mb-sm-0">
            ...
            <h1 class="page-header-title">Timeline</h1>
          </div>
          <!-- End Col -->
        </div>
        <!-- End Row -->
        ...
        <ul class="nav nav-tabs page-header-tabs">
          <li class="nav-item">
            <a class="nav-link" href="./projects.php">
              Projects <span class="badge bg-soft-dark text-dark rounded-pill ms-1">24</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link active" href="./projects-timeline.php">
              Timeline
            </a>
          </li>
        </ul>
      ...
      <div class="text-center">
        <div class="h1">
          <span class="badge bg-primary rounded-pill text-uppercase">
            <i class="bi-patch-check-fill me-1"></i> Pro
          </span>
        </div>
        ...
        <div class="w-lg-75 mx-lg-auto mb-5">
          <img class="img-fluid" src="./assets/svg/illustrations/project-schedule.svg" alt="Image Description">
        </div>

        <p>Create a visual project plan that helps you stay on schedule—so you hit your deadlines. <a class="link" href="#">Learn More <i class="bi-chevron-right"></i></a></p>
